...
import agentItems from '../../constants/agentMenu';
import airlineItems from '../../constants/airlineMenu';
...
class Sidebar extends Component {
  ...
  componentDidMount() {
    ...
    if (isAgent()) {
      this.state.menuItems = agentItems;
    } else if (isAirline()) {
      this.state.menuItems = airlineItems;
    }
