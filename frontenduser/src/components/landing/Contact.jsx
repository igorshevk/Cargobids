...
Contact.defaultProps = {
  SectionbgTitle: "Contatti",
  sectionTitle: "Contatti",
  sectionDescription:
    "Richiedi una dismostrazione live da un nostro consulente presso i tuoi uffici oppure online via Skype.",
  // AddTitle: "Indirizzo",
  // Address: "2750 Quadra Street Victoria, Canada.",
  EmailTitle: "Email",
  Email: "support@cargobids.com",
  PhoneTitle: "Phone",
