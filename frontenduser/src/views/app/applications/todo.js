        ...
        <Row className="app-row survey-app">
          <Colxx xxs="12">
              ...
              {loading && (
                <div className="text-zero top-right-button-container">
                  <Button
                    color="primary"
                    size="lg"
                    className="top-right-button btn-shadow btn-multiple-state btn-lg btn"
            ...
            <div className="mb-2">
              <Button
                color="empty"
                className="pt-0 pl-0 d-inline-block d-md-none btn-shadow btn-multiple-state btn-lg btn"
