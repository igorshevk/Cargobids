        ...
        <Row className="app-row survey-app">
          <Colxx xxs="12">
            ...
            <div className="text-zero top-right-button-container">
              <ButtonDropdown
                className="top-right-button btn-shadow btn-multiple-state btn-lg btn top-right-button-single"
                isOpen={this.state.dropdownSplitOpen}
                toggle={this.toggleSplit}>
                <Button
                  outline
                  className="flex-grow-1 btn btn-shadow btn-multiple-state btn-lg"
                  size="lg"
                  color="primary">
                  SAVE
                </Button>
                      ...
                      <Colxx xxs="12" lg="8">
                        ...
                        <div className="text-center">
                          <Button
                            outline
                            color="primary"
                            className="mt-3 btn-multiple-state btn-shadow btn-lg"
