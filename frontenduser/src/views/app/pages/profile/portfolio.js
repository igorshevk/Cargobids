                  ...
                  <Colxx xxs="12" lg="4" className="mb-4 col-left">
                    <Card className="mb-4">
                      <div className="position-absolute card-top-buttons">
                        <Button outline color={"white"} className="icon-button btn btn-shadow btn-lg btn-multiple-state">
                          <i className="simple-icon-pencil" />
                        </Button>
                      </div>
                      <SingleLightbox thumb="/static/assets/img/profile-pic.jpg" large="/static/assets/img/profile-pic.jpg" className="card-img-top" />
