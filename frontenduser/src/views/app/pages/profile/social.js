              ...
              <TabPane tabId="1">
                <Row>
                  <Colxx xxs="12" className="mb-5">
                    <Card>
                      <SingleLightbox thumb="/static/assets/img/social-header.jpg" large="/static/assets/img/social-header.jpg" className="social-header card-img" />
                    </Card>
                  </Colxx>
                  <Colxx xxs="12" lg="5" xl="4" className="col-left">
                    <SingleLightbox thumb="/static/assets/img/profile-pic-l.jpg" large="/static/assets/img/profile-pic.jpg" className="img-thumbnail card-img social-profile-img" />
