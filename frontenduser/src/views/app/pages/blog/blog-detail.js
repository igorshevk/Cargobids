            ...
            <Fragment>
                ...
                <Row>
                    <Colxx xxs="12" md="12" xl="8" className="col-left">
                        <Card className="mb-4">
                            <SingleLightbox thumb="/static/assets/img/detail-5.jpg" large="/static/assets/img/detail-5.jpg" className="responsive border-0 card-img-top mb-3" />
                            <CardBody>
                                <div className="mb-5">
                    ...
                    <Colxx xxs="12" md="12" xl="4" className="col-left">
                        <Card className="mb-4">
                            <CardBody className="p-0">
                                ...
                                }} className="video-js side-bar-video card-img-top" poster="/static/assets/img/subpage-video-poster.jpg"
                                    sources={[{
