          ...
          <Colxx xxs="12">
            <Card>
              <CardBody>
                ...
                <Button color="primary" onClick={this.toggle} className="mb-1 btn-shadow btn-multiple-state btn btn-primary btn-lg">
              ...
              <CardBody>
                ...
                <Fragment>
                  <div className="border">
                    <Button
                      color="link"
                      className='btn-shadow btn-multiple-state btn btn-link btn-lg'
