          ...
          <Colxx xxs="12">
            <Card className="mb-4">
              <CardBody>
                ...
                <div>
                  <Button color="primary" className='btn-shadow btn-multiple-state btn btn-primary btn-lg' outline onClick={this.toggle}>
                  ...
                  <Modal isOpen={this.state.modal} toggle={this.toggle}>
                    ...
                    <ModalFooter>
                      <Button color="primary" className='btn-shadow btn-multiple-state btn btn-primary btn-lg' onClick={this.toggle}>
                        Do Something
                      </Button>{" "}
                      <Button color="secondary" className='btn-shadow btn-multiple-state btn btn-secondary btn-lg' onClick={this.toggle}>
                        Cancel
                      </Button>
                    </ModalFooter>
                  </Modal>
            ...
            <Card className="mb-4">
              <CardBody>
                ...
                <div>
                  <Button color="primary" className='btn-shadow btn-multiple-state btn btn-primary btn-lg' outline onClick={this.toggleLong}>
                    <IntlMessages id="modal.launch-demo-modal" />
                  </Button>
                  <Modal isOpen={this.state.modalLong} toggle={this.toggleLong}>
                    ...
                    <ModalFooter>
                      <Button color="primary" className='btn-shadow btn-multiple-state btn btn-primary btn-lg' onClick={this.toggleLong}>
                        Do Something
                      </Button>{" "}
                      <Button color="secondary" className='btn-shadow btn-multiple-state btn btn-secondary btn-lg' onClick={this.toggleLong}>
                        Cancel
                      </Button>
                    </ModalFooter>
                  </Modal>
            ...
            <Card className="mb-4">
              <CardBody>
                ...
                <div>
                  ...
                  <Button color="primary" className='btn-shadow btn-multiple-state btn btn-primary btn-lg' outline onClick={this.toggleBack}>
                    <IntlMessages id="modal.launch-demo-modal" />
                  </Button>
                  <Modal
                  ...
                  >
                    ...
                    <ModalFooter>
                      <Button color="primary" className='btn-shadow btn-multiple-state btn btn-primary btn-lg' onClick={this.toggleBack}>
                        Do Something
                      </Button>{" "}
                      <Button color="secondary" className='btn-shadow btn-multiple-state btn btn-secondary btn-lg' onClick={this.toggleBack}>
                        Cancel
                      </Button>
                    </ModalFooter>
                  </Modal>
            ...
            <Card className="mb-4">
              <CardBody>
                ...
                <div>
                  <Button color="primary" className='btn-shadow btn-multiple-state btn btn-primary btn-lg' outline onClick={this.toggleRight}>
                  ...
                  >
                    ...
                    <ModalFooter>
                      <Button color="primary" className='btn-shadow btn-multiple-state btn btn-primary btn-lg' onClick={this.toggleRight}>
                        Do Something
                      </Button>{" "}
                      <Button color="secondary" className='btn-shadow btn-multiple-state btn btn-secondary btn-lg' onClick={this.toggleRight}>
                        Cancel
                      </Button>
                    </ModalFooter>
                  </Modal>
                  ...
                  >
                    ...
                    <ModalBody>
                      ...
                      >
                        ...
                        <ModalFooter>
                          <Button color="primary" className='btn-shadow btn-multiple-state btn btn-primary btn-lg' onClick={this.toggleNested}>
                            Done
                          </Button>{" "}
                          <Button color="secondary" className='btn-shadow btn-multiple-state btn btn-secondary btn-lg' onClick={this.toggleAll}>
                            All Done
                          </Button>
                        </ModalFooter>
                      </Modal>
