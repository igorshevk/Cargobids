...
module.exports = {
  ...
  "user.login-2FA-title": "2FA Verification (Login)",
  ...
  "user.forgot-password-question": "Password dimenticata?",
  ...
  "wizard.next": "Next",
  "wizard.prev": "Back",
  "wizard.registered": "La tua richiesta di registrazione é stata completata!",
  "wizard.async": "Async save for 3 seconds!",

  "quote.create": "Crea Inserzione",
  "quote.update": "Aggiorna Inserzione",
  "quote.review": "Rivedi Inserzione",

  "bid.make": "INSERISCI QUOTAZIONE",
  "bid.update": "AGGIORNA QUOTAZIONE",
  "bid.review": "RIVEDI LA TUA QUOTAZIONE",
  "bid.detail": "DETTAGLI QUOTAZIONE",
  "bid.information": "DETTAGLI QUOTAZIONE",

  "forms.area": "Area Geografica",
  "forms.origin": "Origine",
  "forms.destination": "Sigla Aeroporto Destinazione",
  "forms.piece": "N. Colli",
  "forms.kilo": "Peso (Kgs)",
  "forms.volume": "Volume",
  "forms.title": "Titolo",
  "forms.general-cargo": "General Cargo",
  "forms.dgr": "DGR",
  "forms.perishable": "Perishable",
  "forms.stackable": "Stackable",
  "forms.tiltable": "Girabile",
  "forms.other-special-cargo": "Altro/Merce Speciale",
  "forms.avanti": "Avanti",
  "forms.rfc": "Data Approntamento",
  "forms.notes": "Note",
  "forms.deadline-date": "Chiusura Inserzione:",
  "forms.inserisci-dimensions": "Inserisci dimensioni",
  "forms.dimensions": "DIMENSIONI",
  "forms.cw": "CW",
  "forms.deadline_tooltip":
    "Durata massima inserzione: 15 giorni. Inserisci una data anteriore se necessiti di una quotazione urgente.",
  "forms.total_piece": "Number of pieces",
  "forms.types": "Tipologia",

  "forms.carrier": "VETTORE",
  "forms.rate": "TARIFFA OFFERTA (€):",
  "forms.all_in": "TIPO DI TARIFFA: ",
  "forms.surcharges": "SURCHARGES APPLICABILI: ",
  "forms.cw_required": "CW RICHIESTO (Kg): ",
  "forms.conditions": "CONDIZIONI TARIFFARIE: ",
  "forms.remarks": "Remarks: ",
  "forms.author": "Autore",
  "forms.company": "Azienda",
  "forms.origine": "ORIGINE TARIFFA: ",
  "forms.cw_tooltip":
    "Indicare se la tipologia di merce richiede un Chargeable Weitght superiore",
  "forms.origin_tooltip":
    "Indicare aeroporto da dove origina la tariffa offerta.",
  "forms.condition_tooltip":
    "Selezionare eventuali condizioni da applicare alla tariffa offerta.",
  "forms.remarks_tooltip":
    "Spazio riservato ad inserire una data oppure un volo specifico.",
  closeQuote_tooltip:
    "Clicca sul pulsante se vuoi chiudere definitivamente l'inserzione. Non saranno più possibili quotazioni dai vettori e la tua identità verrà svelata ai vettori che hanno precedentemente inviato quotazioni.",

  "menu.agent": "Agente",
  "menu.quotes": "Inserzioni",
  "menu.create": "Crea",
  ...
  "membership.Subscribe": "Iscriviti",
  Month: "Mese",
  Months: "Mesi",
};
