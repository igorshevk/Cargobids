      ...
      <div className="kt-demo-panel__body kt-scroll">
        <div className="kt-demo-panel__item kt-demo-panel__item--active">
          ...
          <div className="kt-demo-panel__item-preview">
            <img
              alt=""
              src={"/static/media/demos/preview/demo1.jpg"}
            />
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img src={"/static/media/demos/preview/demo2.jpg"} alt="" />
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img src={"/static/media/demos/preview/demo3.jpg"} alt="" />
            <div className="kt-demo-panel__item-preview-overlay">
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img src={"/static/media/demos/preview/demo4.jpg"} alt="" />
            <div className="kt-demo-panel__item-preview-overlay">
              <a href="#" className="btn btn-brand btn-elevate disabled">
                Coming soon
              </a>
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img alt="" src={"/static/media/demos/preview/demo5.jpg"} />
            <div className="kt-demo-panel__item-preview-overlay">
              <a href="#" className="btn btn-brand btn-elevate disabled">
                Coming soon
              </a>
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img src={"/static/media/demos/preview/demo6.jpg"} alt="" />
            <div className="kt-demo-panel__item-preview-overlay">
              <a href="#" className="btn btn-brand btn-elevate disabled">
                Coming soon
              </a>
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img src={"/static/media/demos/preview/demo7.jpg"} alt="" />
            <div className="kt-demo-panel__item-preview-overlay">
              <a href="#" className="btn btn-brand btn-elevate disabled">
                Coming soon
              </a>
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img src={"/static/media/demos/preview/demo8.jpg"} alt="" />
            <div className="kt-demo-panel__item-preview-overlay">
              <a href="#" className="btn btn-brand btn-elevate disabled">
                Coming soon
              </a>
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img src={"/static/media/demos/preview/demo9.jpg"} alt="" />
            <div className="kt-demo-panel__item-preview-overlay">
              <a href="#" className="btn btn-brand btn-elevate disabled">
                Coming soon
              </a>
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img
              src={"/static/media/demos/preview/demo10.jpg"}
              alt=""
            />
            <div className="kt-demo-panel__item-preview-overlay">
              <a href="#" className="btn btn-brand btn-elevate disabled">
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img
              src={"/static/media/demos/preview/demo11.jpg"}
              alt=""
            />
            <div className="kt-demo-panel__item-preview-overlay">
              <a href="#" className="btn btn-brand btn-elevate disabled">
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img
              src={"/static/media/demos/preview/demo12.jpg"}
              alt=""
            />
            <div className="kt-demo-panel__item-preview-overlay">
              <a href="#" className="btn btn-brand btn-elevate disabled">
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img
              src={"/static/media/demos/preview/demo13.jpg"}
              alt=""
            />
            <div className="kt-demo-panel__item-preview-overlay">
              <a href="#" className="btn btn-brand btn-elevate disabled">
        ...
        <div className="kt-demo-panel__item kt-comming-soon">
          ...
          <div className="kt-demo-panel__item-preview">
            <img
              src={"/static/media/demos/preview/demo14.jpg"}
              alt=""
            />
            <div className="kt-demo-panel__item-preview-overlay">
              <a href="#" className="btn btn-brand btn-elevate disabled">
