...
import CartNum3Icon from "../../../_metronic/layout/assets/layout-svg-icons/CartNum3.svg";
                ...
                <div className="kt-mycart__body">
                  <div className="kt-mycart__item">
                    <div className="kt-mycart__container">
                      ...
                      <Link to="cart-item" className="kt-mycart__pic">
                        <img
                          src={"/static/media/products/product9.jpg"}
                          alt="product"
                        />
                      </Link>
                    </div>
                  ...
                  <div className="kt-mycart__item">
                    <div className="kt-mycart__container">
                      ...
                      <Link to="cart-item" className="kt-mycart__pic">
                        <img
                          src={"/static/media/products/product13.jpg"}
                          alt="product"
                        />
                      </Link>
                    </div>
                  ...
                  <div className="kt-mycart__item">
                    <div className="kt-mycart__container">
                      ...
                      <Link to="cart-item" className="kt-mycart__pic">
                        <img
                          src={"/static/media/products/product16.jpg"}
                          alt="product"
                        />
                      </Link>
                    </div>
                  ...
                  <div className="kt-mycart__item">
                    <div className="kt-mycart__container">
                      ...
                      <Link to="cart-item" className="kt-mycart__pic">
                        <img
                          src={"/static/media/products/product15.jpg"}
                          title=""
                          alt=""
                        />
                      </Link>
