          ...
          <div className="kt-widget4">
            <div className="kt-widget4__item">
              <div className="kt-widget4__pic kt-widget4__pic--pic ">
                <img alt="" src={"/static/media/files/jpg.svg"} />
              </div>
              <a
            ...
            <div className="kt-widget4__item">
              <div className="kt-widget4__pic kt-widget4__pic--pic ">
                <img alt="" src={"/static/media/files/zip.svg"} />
              </div>
              <a
                className="kt-widget4__title "
                href="https://keenthemes.com.my/metronic"
            ...
            <div className="kt-widget4__item">
              <div className="kt-widget4__pic kt-widget4__pic--pic ">
                <img alt="" src={"/static/media/files/pdf.svg"} />
              </div>
              <a
                className="kt-widget4__title "
                href="https://keenthemes.com.my/metronic"
            ...
            <div className="kt-widget4__item">
              <div className="kt-widget4__pic kt-widget4__pic--pic ">
                <img alt="" src={"/static/media/files/doc.svg"} />
              </div>
              <a
                className="kt-widget4__title "
                href="https://keenthemes.com.my/metronic"
            ...
            <div className="kt-widget4__item">
              <div className="kt-widget4__pic kt-widget4__pic--pic ">
                <img
                  alt=""
                  src={"/static/media/files/javascript.svg"}
                />
              </div>
              <a
                className="kt-widget4__title "
