          ...
          <div className="kt-widget4">
            <div className="kt-widget4__item ">
              <div className="kt-widget4__pic kt-widget4__pic--pic ">
                <img alt="" src={"/static/media/users/100_5.jpg"} />
              </div>
            ...
            <div className="kt-widget4__item ">
              <div className="kt-widget4__pic kt-widget4__pic--pic ">
                <img alt="" src={"/static/media/users/100_14.jpg"} />
              </div>
              <div className="kt-widget4__info ">
                <a
                  className="kt-widget4__username"
            ...
            <div className="kt-widget4__item ">
              <div className="kt-widget4__pic kt-widget4__pic--pic ">
                <img alt="" src={"/static/media/users/100_4.jpg"} />
              </div>
              <div className="kt-widget4__info ">
                <a
                  className="kt-widget4__username"
            ...
            <div className="kt-widget4__item ">
              <div className="kt-widget4__pic kt-widget4__pic--pic ">
                <img alt="" src={"/static/media/users/100_1.jpg"} />
              </div>
              <div className="kt-widget4__info ">
                <a
                  className="kt-widget4__username"
            ...
            <div className="kt-widget4__item ">
              <div className="kt-widget4__pic kt-widget4__pic--pic ">
                <img alt="" src={"/static/media/users/100_11.jpg"} />
              </div>
              <div className="kt-widget4__info ">
                <a
                  className="kt-widget4__username"
