          ...
          <div className="kt-widget4">
            <div className="kt-widget4__item">
              <div className="kt-widget4__pic kt-widget4__pic--pic">
                <img
                  alt=""
                  src={"/static/media/client-logos/logo5.png"}
                />
              </div>
            ...
            <div className="kt-widget4__item">
              <div className="kt-widget4__pic kt-widget4__pic--pic">
                <img
                  alt=""
                  src={"/static/media/client-logos/logo3.png"}
                />
              </div>
              <div className="kt-widget4__info">
                <a
            ...
            <div className="kt-widget4__item">
              <div className="kt-widget4__pic kt-widget4__pic--pic">
                <img
                  alt=""
                  src={"/static/media/client-logos/logo2.png"}
                />
              </div>
              <div className="kt-widget4__info">
                <a
            ...
            <div className="kt-widget4__item">
              <div className="kt-widget4__pic kt-widget4__pic--pic">
                <img
                  alt=""
                  src={"/static/media/client-logos/logo4.png"}
                />
              </div>
              <div className="kt-widget4__info">
                <a
            ...
            <div className="kt-widget4__item">
              <div className="kt-widget4__pic kt-widget4__pic--pic">
                <img
                  alt=""
                  src={"/static/media/client-logos/logo1.png"}
                />
              </div>
              <div className="kt-widget4__info">
                <a
