import {URL_PREFIX} from "../../app/constants/defaultValues"
        ...
        submenu: [
          {
            title: "Agents",
            bullet: "dot",
            page: URL_PREFIX+"/agents/list",
          },
          {
            title: "Airlines",
            bullet: "dot",
            page: URL_PREFIX+"/airlines/list",
          }
        ]
      },
      {
        ...
        root: true,
        alignment: "left",
        page: URL_PREFIX+"/subscribers/list"
        // translate: "MENU.DASHBOARD"
      },
      /*{
        title: "Material UI",
